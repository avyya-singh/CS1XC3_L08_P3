...
$(BUILD_DIR)/max: $(SRC_DIR)/max.c $(BUILD_DIR)/library.o | $(BUILD_DIR)
	$(CC) $(CFLAGS) $^ -o $@

$(BUILD_DIR)/multiply: $(SRC_DIR)/multiply.c $(BUILD_DIR)/library.o | $(BUILD_DIR)
	$(CC) $(CFLAGS) $^ -o $@

$(BUILD_DIR)/square: $(SRC_DIR)/square.c $(BUILD_DIR)/library.o | $(BUILD_DIR)
	$(CC) $(CFLAGS) $^ -o $@
